...
pub mod location_reporter_table;
pub mod ship_table;
pub mod ship_type;
...
pub use location_reporter_table::*;
pub use ship_table::*;
...
pub enum Reducer {
    AddLocationReport { ship_id: u64, lat: f64, lon: f64 },
    AddShip { name: String },
}
...
impl __sdk::Reducer for Reducer {
    ...
    fn args_bsatn(&self) -> Result<Vec<u8>, __sats::bsatn::EncodeError> {
        match self {
            Reducer::AddLocationReport { ship_id, lat, lon } => {
            ...
            Reducer::AddShip { name } => {
                __sats::bsatn::to_vec(&add_ship_reducer::AddShipArgs { name: name.clone() })
            }
            _ => unreachable!(),
        }
    }
...
#[doc(hidden)]
pub struct DbUpdate {
    location_reporter: __sdk::TableUpdate<LocationReport>,
    ...
    fn try_from(raw: __ws::v2::TransactionUpdate) -> Result<Self, Self::Error> {
        ...
        for table_update in __sdk::transaction_update_iter_table_updates(raw) {
            match &table_update.table_name[..] {
                "location_reporter" => db_update
                    .location_reporter
                    .append(location_reporter_table::parse_table_update(table_update)?),
                "ship" => db_update
                    .ship
...
impl __sdk::DbUpdate for DbUpdate {
    fn apply_to_client_cache(
        ...
        diff.location_reporter = cache
            .apply_diff_to_table::<LocationReport>("location_reporter", &self.location_reporter)
...
pub struct AppliedDiff<'r> {
    location_reporter: __sdk::TableAppliedDiff<'r, LocationReport>,
...
impl __sdk::SpacetimeModule for RemoteModule {
    ...
    fn register_tables(client_cache: &mut __sdk::ClientCache<Self>) {
        location_reporter_table::register_table(client_cache);
        ship_table::register_table(client_cache);
    }
    const ALL_TABLE_NAMES: &'static [&'static str] = &["location_reporter", "ship"];
}
